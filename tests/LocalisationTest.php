...
class LocalisationTest extends TestCase
{
    ...
    function test_basicTranslation()
    {
        ...
        $this->assertEquals('bonjour', $this->l->getTranslation('hello', 'FR'));
        $this->assertEquals('dog', $this->l->getTranslation('dog'));
        $this->assertEquals("J'ai mangé du chocolat $4652", $this->l->getTranslation('I hate chocolate $4652', 'FR'));
    }
    ...
    function test_newLang()
    {
        ...
        $this->assertEquals('hello', $this->l->getTranslation('hello', 'SP'));
    }
}
